...
//     mapping(address => Types.UserDetails[]) internal manufacturerDistributorsList;
//     mapping(address => Types.UserDetails[]) internal distributorWholesalersList;
//     mapping(address => Types.UserDetails[]) internal wholesalerRetialersList;
...
//             user.role == Types.UserRole.distributor
//         ) {
...
//         } else if (
//             get(myAccount).role == Types.UserRole.distributor &&
//             user.role == Types.UserRole.wholesaler
//         ) {
//             // Only suppliers are allowed to add vendors
//             supplierVendorsList[myAccount].push(user);
//             add(user); // To add user to global list
//         } else if (
//             get(myAccount).role == Types.UserRole.wholesaler &&
//             user.role == Types.UserRole.retailer
//         ) {
